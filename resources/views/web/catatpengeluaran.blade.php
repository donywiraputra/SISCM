...
<div class="container">
<div class="row">
  <h4 class="center-align">Catat Pengeluaran</h4>
</div>
</div>
<div class="divider"></div>
<div class="container">
...
<form action="{{url(action('CatatPengeluaranController@catatPengeluaran'))}}" method="post">

  <div class="row">
    <div class="input-field col s12 m6 l6">
      <textarea id="textarea1" name="keterangan" class="materialize-textarea" autocomplete="off"></textarea>
  ...
  <div class="row">
    <div class="input-field col s12 m6 l6">
      <input name="jumlah" id="jumlah" type="text" class="validate" autocomplete="off">
  ...
  <div class="row">
    <div class="col s12 m6 l6">
      <div class="right">
        <a href="/pengeluaran" class="btn waves-effect waves-light btn-small grey darken-2">Kembali</a>
        &nbsp
