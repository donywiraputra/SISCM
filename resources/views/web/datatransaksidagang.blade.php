    ...
    font-weight: 500;">Master data</div>
      <div class="collapsible-body">
        <ul>
          ...
          <li class="active cyan lighten-5"><a class="waves-effect black-text" style="padding-left: 45px;" href="datatransdagang">Data transaksi dagang</a></li>
